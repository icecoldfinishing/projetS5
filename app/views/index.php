...
<head>
    ...
    <link rel="stylesheet" href="<?=$base_url?>/public/assets_template/css/style.css">
    <link rel="stylesheet" href="<?=$base_url?>/public/assets_template/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?=$base_url?>/public/assets_template/lib/lightbox/css/lightbox.min.css">
    <link rel="stylesheet" href="<?=$base_url?>/public/assets_template/lib/owlcarousel/assets_template/owl.carousel.min.css">
    <link rel="stylesheet" href="<?=$base_url?>/public/assets_template/lib/animate/animate.min.css">
</head>
...
<body>
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="<?=$base_url?>/public/assets_template/img/carousel-1.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row g-0 service-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="service-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="<?=$base_url?>/public/assets_template/img/icon/icon-6.png" alt="Icon">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="service-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="<?=$base_url?>/public/assets_template/img/icon/icon-8.png" alt="Icon">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="service-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="<?=$base_url?>/public/assets_template/img/icon/icon-9.png" alt="Icon">
                        </div>
        ...
        <div class="container feature px-lg-0">
            <div class="row g-0 mx-lg-0">
                    ...
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    <div class="btn-square bg-white rounded-circle" style="width: 64px; height: 64px;">
                                        <img class="img-fluid" src="<?=$base_url?>/public/assets_template/img/icon/icon-7.png" alt="Icon">
                                    </div>
                                    <div class="ms-4">
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    <div class="btn-square bg-white rounded-circle" style="width: 64px; height: 64px;">
                                        <img class="img-fluid" src="<?=$base_url?>/public/assets_template/img/icon/icon-10.png" alt="Icon">
                                    </div>
                                    <div class="ms-4">
                ...
                <div class="col-lg-6 pe-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="<?=$base_url?>/public/assets_template/img/feature.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 portfolio-container">
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner">
                        <img class="img-fluid w-100" src="<?=$base_url?>/public/img/portfolio-1.jpg"  alt="">
                        ...
                        <div class="portfolio-text text-center bg-white p-4">
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href="<?=$base_url?>/public/img/portfolio-1.jpg"  data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner">
                        <img class="img-fluid w-100" src="<?=$base_url?>/public/img/portfolio-2.jpg" alt="">
                        <div class="text-center p-4">
                        ...
                        <div class="portfolio-text text-center bg-white p-4">
                            ...
                            <h5 class="lh-base mb-3">Smart CCTV Security Systems That Fits Your Business</h5>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-primary rounded-circle mx-1"  href="<?=$base_url?>/public/img/portfolio-2.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner">
                        <img class="img-fluid w-100" src="<?=$base_url?>/public/img/portfolio-3.jpg" alt="">
                        <div class="text-center p-4">
                        ...
                        <div class="portfolio-text text-center bg-white p-4">
                            ...
                            <h5 class="lh-base mb-3">Smart CCTV Security Systems That Fits Your Business</h5>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href="<?=$base_url?>/public/assets_template/img/portfolio-3.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner">
                        <img class="img-fluid w-100" src="<?=$base_url?>/public/img/portfolio-4.jpg"" alt="">
                        <div class="text-center p-4">
                        ...
                        <div class="portfolio-text text-center bg-white p-4">
                            ...
                            <h5 class="lh-base mb-3">Smart CCTV Security Systems That Fits Your Business</h5>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href="<?=$base_url?>/public/assets_template/img/portfolio-4.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner">
                        <img class="img-fluid w-100" src="<?=$base_url?>/public/img/portfolio-5.jpg" alt="">
                        <div class="text-center p-4">
                        ...
                        <div class="portfolio-text text-center bg-white p-4">
                            ...
                            <h5 class="lh-base mb-3">Smart CCTV Security Systems That Fits Your Business</h5>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href="<?=$base_url?>/public/assets_template/img/portfolio-5.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner">
                        <img class="img-fluid w-100" src="<?=$base_url?>/public/img/portfolio-6.jpg" alt="">
                        <div class="text-center p-4">
                        ...
                        <div class="portfolio-text text-center bg-white p-4">
                            ...
                            <h5 class="lh-base mb-3">Smart CCTV Security Systems That Fits Your Business</h5>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href="<?=$base_url?>/public/assets_template/img/portfolio-6.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid bg-light overflow-hidden my-5 px-lg-0">
        <div class="container quote px-lg-0">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="<?=$base_url?>/public/assets_template/img/quote.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='<?=$base_url?>/public/assets_template/img/testimonial-1.jpg' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                    <h4>Client Name</h4>
                    <span class="text-primary">Profession</span>
                </div>
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='<?=$base_url?>/public/assets_template/img/testimonial-2.jpg' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                    <h4>Client Name</h4>
                    <span class="text-primary">Profession</span>
                </div>
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='<?=$base_url?>/public/assets_template/img/testimonial-3.jpg' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                    <h4>Client Name</h4>
                    <span class="text-primary">Profession</span>
                </div>
    ...
    <!-- Template Javascript -->
    <script src="<?=$base_url?>//assets_template/js/main.js"></script>
</body>
