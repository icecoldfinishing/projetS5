                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <i class="bi bi-calendar-check"></i> Modification - Réservation #<?= $reservation['id_reservation'] ?>
                                    </h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="post" action="<?= Flight::base() ?>/reservation/update/<?= $reservation['id_reservation'] ?>">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="id_club" class="form-label">ID Club</label>
                                                    <input type="number" class="form-control" id="id_club" name="id_club"
                                                           value="<?= $reservation['id_club'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="date_reservation" class="form-label">Date de réservation</label>
                                                    <input type="datetime-local" class="form-control" id="date_reservation" name="date_reservation"
                                                           value="<?= date('Y-m-d\TH:i', strtotime($reservation['date_reservation'])) ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="datetime-local" class="form-control" id="date_reserve" name="date_reserve"
                                                           value="<?= date('Y-m-d\TH:i', strtotime($reservation['date_reserve'])) ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="mb-3">
