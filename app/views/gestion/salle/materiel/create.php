            ...
            <div class="page-heading">
                <div class="page-title">
                    <div class="row align-items-center mb-3">
                        <div class="col-md-6">
                            <h3 class="fw-bold">Ajouter un matériel</h3>
                            <p class="text-muted">Formulaire d'enregistrement d'un nouveau matériel</p>
                        </div>
                    </div>
                </div>
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?= Flight::base() ?>/materiel/store">
                                <div class="row">
