                ...
                <div class="page-title">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <h3 class="fw-bold mb-1">Suivi du matériel</h3>
                            <p class="text-muted">Voici la liste du matériel en salle</p>
                        </div>
                        <div class="col-md-6 text-md-end">
                            <a href="<?= Flight::base() ?>/materiel/create" class="btn btn-primary">
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0">Liste des types de matériels</h4>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?= Flight::base() ?>/materiel/<?= $m['id_type'] ?>" class="btn btn-sm btn-outline-primary">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                        <a href="<?= Flight::base() ?>/materiel/<?= $m['id_type'] ?>/edit" class="btn btn-sm btn-outline-warning">
                                                            <i class="bi bi-pencil"></i>
                                                        </a>
                                                        <a href="<?= Flight::base() ?>/materiel/<?= $m['id_type'] ?>/delete" class="btn btn-sm btn-outline-danger" onclick="return confirm('Supprimer ?')">
