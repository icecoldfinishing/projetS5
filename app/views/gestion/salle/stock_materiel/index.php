    ...
    <div id="app">
        ...
        <div id="main">
            <div class="container mt-4">
                ...
                <form method="POST" action="<?= Flight::base() ?>/stock/add" class="row g-3 mt-4">
                    <div class="col-md-4">
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <?php foreach ($stock as $entry): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= Flight::base() ?>/stock/delete/<?= $entry['id_suivi'] ?>" class="btn btn-sm btn-danger">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
